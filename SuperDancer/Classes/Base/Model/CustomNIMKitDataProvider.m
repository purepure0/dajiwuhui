...
@interface CustomNIMKitDataRequest : NSObject
...
@implementation CustomNIMKitDataRequest{
...
@interface CustomNIMKitDataProvider()<NIMUserManagerDelegate,NIMTeamManagerDelegate,NIMLoginManagerDelegate>

@property (nonatomic,strong) UIImage *defaultUserAvatar;

@property (nonatomic,strong) UIImage *defaultTeamAvatar;

@property (nonatomic,strong) CustomNIMKitDataRequest *request;

@end


@implementation CustomNIMKitDataProvider

- (instancetype)init{
    self = [super init];
    if (self) {
        _request = [[CustomNIMKitDataRequest alloc] init];
