...
- (void)viewDidLoad {
    ...
    self.qRCodeImgView.image = [SGQRCodeGenerateManager generateWithDefaultQRCodeData:NSStringFormat(@"djwh%@",self.team.teamId) imageViewWidth:self.qRCodeImgView.frame.size.width];
