...
@interface ThreeRightView ()<UITableViewDelegate,UITableViewDataSource>
...
-(void)addSubviews{
    ...
    image.image =[UIImage imageNamed:@"bg_ssj"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ThirdRightTableViewCell *cell = [tableVIew dequeueReusableCellWithIdentifier:@"ThirdRightTableViewCell"];
    if (!cell) {
        cell = [[ThirdRightTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"ThirdRightTableViewCell"];
